  ...
  return (
    <section className="relative overflow-hidden bg-[#F6F7F4] px-4 py-10 sm:px-6 md:px-8 lg:px-12">
      ...
      <div className="relative z-10 mx-auto grid max-w-[1400px] gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
        <div
          className="order-first self-start pt-2 text-center lg:order-last lg:pt-0 lg:text-left"
          style={{
        ...
        >
          ...
          <div className="mx-auto mt-5 max-w-3xl space-y-4 text-left text-base leading-7 text-[#343454]/85 lg:mx-0">
            <p>
          ...
          <div className="mt-7 flex flex-col justify-center gap-5 sm:flex-row sm:flex-wrap lg:justify-start">
            <a
              href="#contact-form"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#C9A84C] to-[#E8C96A] px-8 py-3.5 text-[15px] font-semibold text-[#071F14] shadow-xl shadow-[#C9A84C]/20 transition duration-500 hover:-translate-y-0.5"
            >
              Send a Message
            ...
            <Link
              href="/login"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#071F14]/10 bg-white/50 px-8 py-3.5 text-[15px] font-semibold text-[#232336] backdrop-blur-xl transition duration-500 hover:-translate-y-0.5 hover:bg-white"
            >
              <Stethoscope
                size={20}
                strokeWidth={1.8}
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#C9A84C]/20 bg-[#FFF7F0] px-8 py-3.5 text-[15px] font-semibold text-[#9A7A2E] shadow-sm transition duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_35px_rgba(201,168,76,0.16)]"
            >
        ...
        >
          <div className="relative overflow-hidden rounded-[2rem] border border-[#C9A84C]/60 bg-[#071F14] p-6 shadow-2xl shadow-[#071F14]/25 transition-all duration-700 hover:shadow-[0_0_55px_rgba(201,168,76,0.15)] sm:p-8">
            ...
            <div className="relative z-10">
              <div className="relative mx-auto mb-8 h-52 overflow-hidden rounded-[2rem] border border-[#C9A84C]/25 bg-black shadow-2xl shadow-black/25 sm:h-64 md:h-72">
                ...
                >
                  ...
                  <p
                    className="text-[1.9rem] font-semibold text-white"
                    style={{ fontFamily: "'Cormorant Garamond', serif" }}
                  >
                    Reach Us Anytime
                  </p>
          ...
          >
            <div className="flex items-center gap-4">
              <p
                className="text-3xl font-semibold text-[#C9A84C]"
                style={{ fontFamily: "'Cormorant Garamond', serif" }}
              >
                24h
              </p>
